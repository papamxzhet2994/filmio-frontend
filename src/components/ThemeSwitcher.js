        ...
        <div className="flex items-center">
            <button
                ...
                className={`relative inline-flex items-center justify-center p-4 w-16 h-16 rounded-full border-2 border-transparent text-white text-sm font-bold transition-all duration-300 ease-in-out ${
                    theme === "light"
                        ? "bg-white hover:bg-gray-200 focus:ring-2 focus:ring-gray-400"
                        : "bg-gray-800 hover:bg-gray-700 focus:ring-2 focus:ring-gray-600"
                }`}
            >
                <div
                ...
                />
                <div
                    className={`absolute w-10 h-10 bg-gray-800 rounded-full transition-all duration-300 ease-in-out transform ${
                        theme === "light" ? "translate-x-16" : "translate-x-0"
                    }`}
                />
                <span
                    className={`absolute text-gray-800 text-sm font-bold transition-all duration-300 ease-in-out transform ${
