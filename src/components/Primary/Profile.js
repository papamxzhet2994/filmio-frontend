...
const Profile = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row min-h-screen bg-white dark:bg-neutral-900 text-neutral-900 dark:text-white justify-center items-center p-4 sm:p-6 lg:p-8 rounded-2xl">
            {/*<LightRope />*/}
            ...
            <motion.div className="relative w-full sm:w-[500px] lg:w-[700px] h-auto sm:h-[600px] bg-neutral-100 dark:bg-neutral-800 p-4 sm:p-6 rounded-2xl shadow-lg flex flex-col items-center">
                <div className="text-center mb-4 sm:mb-6">
                    <h1 className="text-lg sm:text-xl font-semibold">{user.username}</h1>
                    <p className="text-sm sm:text-base text-neutral-600 dark:text-neutral-400">{user.email}</p>
                </div>
                <ul className="space-y-2 w-full">
                    <li>
                        <button
                            onClick={() => setCurrentPage("profile")}
                            className={`w-full py-2 sm:py-3 px-4 text-left rounded-lg hover:bg-neutral-200 dark:hover:bg-neutral-800 ${currentPage === "profile" ? "bg-neutral-200 dark:bg-neutral-800" : ""}`}
                        >
                    ...
                    <li>
                        <button
                            ...
                            className={`w-full py-2 sm:py-3 px-4 text-left rounded-lg hover:bg-neutral-200 dark:hover:bg-neutral-800 ${currentPage === "settings" ? "bg-neutral-200 dark:bg-neutral-800" : ""}`}
                        >
                    ...
                    <div className="dark:bg-neutral-900 p-4 rounded-lg">
                        ...
                        <div className="flex flex-col items-center gap-4 mb-6">
                            {avatarPreview && (
                                <img
                                    src={avatarPreview}
                                    alt="Avatar"
                                    className="w-12 h-12 sm:w-16 sm:h-16 rounded-full border-2 border-gray-300 dark:border-gray-700 object-cover bg-neutral-200 dark:bg-neutral-800"
                                />
                            )}
                            ...
                            <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                                <button
                                    ...
                                    className="bg-blue-500 text-white px-4 py-2 sm:py-3 rounded-full hover:bg-blue-600 transition-colors"
                                >
                                    Загрузить аватар
                                </button>
                                <button
                                    onClick={deleteAvatar}
                                    className="bg-red-500 text-white px-4 py-2 sm:py-3 rounded-full hover:bg-red-600 transition-colors"
                                >
                                    Удалить аватар
                                </button>
                            </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="mt-6">
                                ...
                                {isLinkSectionOpen && (
                                    <motion.div className={"relative bg-white dark:bg-neutral-900 rounded-2xl shadow-xl w-full max-w-md sm:max-w-lg overflow-hidden"}
                                        initial={{opacity: 0}}
                                        animate={{opacity: 1}}
                                        exit={{opacity: 0}}
